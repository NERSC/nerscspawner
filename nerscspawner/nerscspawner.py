...
class NERSCSlurmSpawnerBase(BatchSpawnerRegexStates):
...
class NERSCSlurmSpawner(NERSCSlurmSpawnerBase):
...
class NERSCSlurmSpawnerShared(NERSCSlurmSpawnerBase):
